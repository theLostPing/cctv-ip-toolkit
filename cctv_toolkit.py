...
""")
    ...
    WHATS_NEW = {
        "5.2.0": (
            ...
            [
                "• Fixed Bosch discovery — picking Bosch now actually finds Bosch cameras.",
                "• Brand-new Bosch cameras show up instead of being skipped.",
                "• Discovered list only shows the brand you picked.",
                "• Scan Network searches your selected brand, not always Axis.",
                "• Brand now shown in the title bar.",
                "• Bosch: reboot and factory reset stop claiming success when the camera is unreachable.",
                "• Bosch: cameras that already have a password can be re-run.",
                "• Fixed a freeze after a failed factory default.",
                "• Fixed a temporary network address sticking permanently and breaking DHCP.",
                "• Fixed factory reset waiting at the wrong address for non-Axis brands.",
                "• One 'Back to wizard' button instead of two.",
                "• Setup and Operations now offer the same list of jobs.",
                "• Wrong camera model lets you skip that one instead of quitting the run.",
                "• Set hostname is on by default.",
            ],
        ),
        "5.1.1": (
        ...
        "4.4.5": (
            ...
            [
                "• Installer now auto-launches the toolkit after install via a 3-second delay launcher (`cmd /c \"timeout 3 && start <exe>\"`). The delay lets Windows release file locks on the freshly-extracted PyInstaller temp dir, fixing the v4.4.0 'Failed to load Python DLL' race that forced auto-relaunch to be dropped in v4.4.4.",
                "• In-app update flow now ends with the new version launching automatically — no manual click on the Start Menu shortcut after install.",
                "• Standard Inno 'Launch CCTVIPToolkit' checkbox on the Setup Complete page is back, ticked by default.",
            ],
        ),
        "4.4.4": (
